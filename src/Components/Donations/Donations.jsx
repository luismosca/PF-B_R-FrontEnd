        ...
        <div className={style.divDonation}>
            ...
            <div className={style.donationContainer}>
                ...
                <div className={style.donationItem}>
                    ...
                    <h1 
                        className={style.h1Donation}
                        >Una taza de cafe ($5)
                    </h1>

                    <div className={style.imgContainer}>
                        <img src="https://img.freepik.com/vector-premium/expresion-cafe-dos-tazas-dibujos-animados_24877-17515.jpg" 
                ...
                <div className={style.donationItem}>
                    ...
                    <div className={style.imgContainer}>
                        <img src="https://img.freepik.com/vector-premium/almuerzo-fresco-delicioso_24877-3193.jpg?w=2000" 
                        className={style.imgDonation}
                        alt="Cafe" />
                    </div>
